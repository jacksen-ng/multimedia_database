CREATE OR REPLACE FUNCTION insert_check_performance() RETURNS TRIGGER AS '
DECLARE
...
BEGIN
    ...
    -- Insert training records into training_table
...
BEGIN
    -- Delete existing entries for this player in training_required table
